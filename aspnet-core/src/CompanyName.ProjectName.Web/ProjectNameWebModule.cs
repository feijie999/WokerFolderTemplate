...
namespace CompanyName.ProjectName.Web
{
    ...
    public class ProjectNameWebModule : AbpModule
    {
        public override void PreConfigureServices(ServiceConfigurationContext context)
        {
            context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
            {
                options.AddAssemblyResource(
                    ...
                    typeof(ProjectNameDomainModule).Assembly,
                    typeof(ProjectNameDomainSharedModule).Assembly,
                    typeof(ProjectNameApplicationModule).Assembly,
        ...
        private void ConfigureVirtualFileSystem(IWebHostEnvironment hostingEnvironment)
        {
            if (hostingEnvironment.IsDevelopment())
            {
                Configure<AbpVirtualFileSystemOptions>(options =>
                {
                    ...
                    options.FileSets.ReplaceEmbeddedByPhysical<ProjectNameApplicationModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}CompanyName.ProjectName.Application"));
        ...
        private void ConfigureNavigationServices()
        {
            ...
            {
                options.MenuContributors.Add(new ProjectNameMenuContributor());
            });
        }
